...
def create_wildlife_dataset_splits(source_directory, target_directory, target_split_name, use_all=False):
    ...
    if use_all:
        ...
        __create_wildlife_splits_by_categories(tuple_mappings, target_directory, target_split_name)
...
def __create_wildlife_splits_by_categories(tuple_mappings, target_directory, target_split_name):    
    # We need to create train and train_dev on the same run, so that train images are not within the train_dev set
    categories = [
